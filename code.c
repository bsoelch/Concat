...
tuple2 local16 = tmp37;
int32_t const tmp38 = (++local8);
printf("%"PRIi32"\n",tmp38);
local10 = ((int32_t)2);
procedure2();
...
printf("%"PRIi32"\n",tmp42);
int64_t const tmp43 = (local16).e1;
(local16).e0 = tmp43;
int64_t* const tmp44 = &((local16).e0);
printf("%p\n",(void*)tmp44);
tuple2* const tmp45 = &(local16);
tuple2* local17 = tmp45;
int64_t const tmp46 = ((local17)+(((int32_t)0)))->e0;
printf("%"PRIi64"\n",tmp46);
int32_t const tmp47 = 1;
tuple8 const tmp48 = {.e0=stringChars2+0,.e1=12};
...
printf("%"PRIi8"\n",tmp51);
tuple8 const tmp52 = {.e0=stringChars2+6,.e1=5};
int64_t const tmp53 = (tmp52).e1;
printf("%"PRIi64"\n",tmp53);
bool const tmp54 = (local8==((int32_t)0));
int32_t tmp56;
if(tmp54){
...
bool const tmp58 = (local9!=((int32_t)0));
int32_t tmp61;
bool tmp60;
if(tmp58){
bool const tmp59 = (local8>=((int32_t)42));
tmp60 = tmp59;
tmp61 = tmp57;
}else{
tmp60 = ((bool)0);
...
printf("%"PRIi32"\n",tmp56);
int32_t* const tmp64 = &(local8);
int32_t* local18 = tmp64;
int32_t* const tmp65 = (++local18);
(*(tmp65)) = ((int32_t)2);
int32_t local19 = 10;
do{
bool const tmp66 = (local19>((int32_t)0));
if(!tmp66)
  break;
printf("%"PRIi32"\n",local19);
int32_t const tmp67 = (local19-((int32_t)1));
local19 = tmp67;
}while(1);
printf("%s\n",((bool)1)?"true":"false");
}
tuple8 const tmp68 = {.e0=stringChars1+0,.e1=23};
tuple8 global8 = tmp68;
int8_t global9 = 65;
tuple8 const tmp69 = {.e0=stringChars0+0,.e1=39};
tuple8 global10 = tmp69;
